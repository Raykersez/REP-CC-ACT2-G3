...
import pickle
import numpy as np
# postgresql://postgres.fzbhgkwincsyvklpyqsr:[YOUR-PASSWORD]@aws-1-us-east-2.pooler.supabase.com:6543/postgres
import psycopg2
# Fetch variables
USER = "postgres.fzbhgkwincsyvklpyqsr" #os.getenv("user")
PASSWORD = "CH75U:}6qo9bCH75U:}6qo9bCH75U:}6qo9b"# os.getenv("password")
